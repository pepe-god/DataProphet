...
SEARCH_FIELDS_MAP = {
    ...
    "Ölüm Tarihi": "OLUMTARIHI",
    "Doğum Yeri": "DOGUMYERI",
    "Memleket İli": "MEMLEKETIL",
    "Memleket İlçesi": "MEMLEKETILCE",
    "Memleket Köyü": "MEMLEKETKOY",
    "Adres İli": "ADRESIL",
    "Adres İlçesi": "ADRESILCE",
    "Aile Sıra No": "AILESIRANO",
    "Birey Sıra No": "BIREYSIRANO",
...
class Person:
    ...
    GSM_LIST: list[str] | None = None  # GSMDATA'dan gelecek çoklu numaralar
    BABAADI: str = ""
    BABATC: str = ""
    ANNEADI: str = ""
    ANNETC: str = ""
    ...
    _FIELD_NAMES: frozenset = frozenset()
    ...
    def to_csv_row(self, category: str = "Veri") -> list[str]:
        ...
        return [clean_value(val) for val in row]
