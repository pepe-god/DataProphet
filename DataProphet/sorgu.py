    ...
    with open(output_file, "w", encoding="utf-8") as file:
        ...
        if kisi:
            ...
            if anne_result:
                ...
                sorgu_dayi_teyze = f"SELECT * FROM `101m` WHERE (ANNETC = '{anne_result[0]}' OR BABATC = '{anne_result[1]}') AND TC != '{anne_tc}'"
            ...
            if baba_result:
                ...
                sorgu_amca_hala = f"SELECT * FROM `101m` WHERE (ANNETC = '{baba_result[0]}' OR BABATC = '{baba_result[1]}') AND TC != '{baba_tc}'"
